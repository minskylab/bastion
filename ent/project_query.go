...
func (pq *ProjectQuery) QueryRoles() *RoleQuery {
...
func (pq *ProjectQuery) QueryOrganizations() *OrganizationQuery {
...
func (pq *ProjectQuery) WithRoles(opts ...func(*RoleQuery)) *ProjectQuery {
	query := &RoleQuery{config: pq.config}
...
func (pq *ProjectQuery) WithOrganizations(opts ...func(*OrganizationQuery)) *ProjectQuery {
	query := &OrganizationQuery{config: pq.config}
	for _, opt := range opts {
		opt(query)
	}
...
func (pq *ProjectQuery) sqlAll(ctx context.Context) ([]*Project, error) {
	...
	if query := pq.withTasks; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(project.TasksPrimaryKey[0], fks...))
			},
			ScanValues: func() [2]interface{} {
				return [2]interface{}{new(uuid.UUID), new(uuid.UUID)}
			},
	...
	if query := pq.withOrganizations; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(project.OrganizationsPrimaryKey[1], fks...))
			},
			ScanValues: func() [2]interface{} {
				return [2]interface{}{new(uuid.UUID), new(uuid.UUID)}
			},
