...
func (rq *RoleQuery) QueryMembers() *MemberQuery {
...
func (rq *RoleQuery) WithMembers(opts ...func(*MemberQuery)) *RoleQuery {
	query := &MemberQuery{config: rq.config}
	...
	if query := rq.withMembers; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(role.MembersPrimaryKey[1], fks...))
			},
